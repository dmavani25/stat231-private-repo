...
```{r, fig.height = 2.5, fig.width = 4.5, fig.align = 'center'}
library(mdsr)
MLBPlot <- ggplot(data = MLB_teams,aes(x = WPct,y = payroll)) + geom_point(color = "red") + labs(x = "Winning Percentage, %", y = "Payroll in context", title = "Relationship between payroll and winning percentages") + geom_smooth(color = "black")
...
ggplot(storms, aes(x = lat, y = long)) + 
  ...
  labs(y = "Longitude", x = "Latitude", title = "Path of Storms")
