...
ggplot(data = hourly_new_activities_dataset,
         mapping = aes(x = new_activities,
                       ...
                       fill = time_in_hours)) +
  geom_col()+
    labs(title = "Actual time doing each activity 
